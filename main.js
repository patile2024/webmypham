...
# Countdown
********************************************************/
/*JS COUNTDOWN CHO 1 Sáº¢N PHáº¨M*/
...
function awe_countDown(selector) {
    ...
    var x = setInterval(function () {
        ...
        selector.html("<span>" + days + "<p>NgĂ y</p></span>" + "<span>" + hours + "<p>Giá»</p></span>" + "<span>" + minutes + "<p>PhĂºt</p></span>" + "<span>" + seconds + "<p>GiĂ¢y</p></span>");
        // If the count down is finished, write some text
        if (distance < 0) {
            clearInterval(x);
            selector.html("<div><span>00<p>NgĂ y</p></span></div><div><span>00<p>Giá»</p></span></div><div><span>00<p>PhĂºt</p></span></div><div><span>00<p>GiĂ¢y</p></span></div>");
        }
    }, 1000);
}
/*JS COUNTDOWN DANH Má»¤C Sáº¢N PHáº¨M*/
function awe_countDown2(selector2) {
    ...
    var x = setInterval(function () {
        ...
        var seconds = Math.floor((distance % (1000 * 60)) / 1000);
        // Display the result in the element
        selector2.html("<div><span>" + days + "<p>NgĂ y</p></span></div>" + "<div><span>" + hours + "<p>Giá»</p></span></div>" + "<div><span>" + minutes + "<p>PhĂºt</p></span></div>" + "<div><span>" + seconds + "<p>GiĂ¢y</p></span></div>");
        // If the count down is finished, write some text
        if (distance < 0) {
            clearInterval(x);
            selector2.html("Khuyáº¿n mĂ£i háº¿t háº¡n");
        }
    }, 1000);
}
...
function callbackW() {
    ...
    $(".iWishAdd").click(function () {			
        ...
        if (Haravan.template == 'collection' || Haravan.template == 'index') {
        ...
        if (iwish_cid == 0) {
            ...
            iWish$.post(iWishLink, postObj, function (data) {
                ...
                if (result) {
                    if (Haravan.template == "product") {
                        iWish$('.iWishAdd').addClass('iWishHidden'), iWish$('.iWishAdded').removeClass('iWishHidden');
                        if (redirect == 2) {
                            iWishSubmit(iWishLink, { cust: iwish_cid });
                        }
                    }
                    else if (Haravan.template == 'collection' || Haravan.template == 'index') {
...
/*CÄ‚N CHIá»€U CAO KHá»I TAB SP Ná»”I Báº¬T*/
